...
func main() {
	...
	normalNode := logicImpl.CreatePlayerNode(nodeListenerAddr, playerListenerIpAddress, pubKey, privKey, serverAddr)
	normalNode.SybilType = "ghost"
	normalNode.RunGame(playerListenerIpAddress)
}
