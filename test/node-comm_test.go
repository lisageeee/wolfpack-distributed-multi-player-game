...
func TestNodeToNodeSendMove(t *testing.T) {
	...
	node1 := l.CreatePlayerNode(":12800", ":12801", ":12802", pub, priv, ":8081")

	pub, priv = key.GenerateKeys()
	node2 := l.CreatePlayerNode(":12900", ":12901", ":12092", pub, priv, ":8081")
...
func TestNodeToNodeSendGameState(t *testing.T) {
	...
	// Create player node and get pixel interface
	pub, priv := key.GenerateKeys()
	node1 := l.CreatePlayerNode(":12200", ":12201", ":12202", pub, priv, ":8081")

	pub, priv = key.GenerateKeys()
	node2 := l.CreatePlayerNode(":11900", ":11901", ":11092", pub, priv, ":8081")
